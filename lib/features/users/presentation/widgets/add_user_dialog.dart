...
class AddUsereDialog extends StatefulHookConsumerWidget {
  const AddUsereDialog({
    super.key,
  });

  @override
  ConsumerState<AddUsereDialog> createState() => _AddUsereDialogState();
}

class _AddUsereDialogState extends ConsumerState<AddUsereDialog>
    with Validators, AppTextFormatter {
  final formKey = GlobalKey<FormState>();
  @override
  Widget build(BuildContext context) {
    final colors = context.appColors;
    final user = useState(UserModel.initial());
