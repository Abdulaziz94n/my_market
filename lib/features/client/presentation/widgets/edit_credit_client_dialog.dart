...
class EditCreditClienttDialog extends StatefulHookConsumerWidget {
  const EditCreditClienttDialog({
    super.key,
    required this.client,
  });
  final CreditClientModel client;
  @override
  ConsumerState<EditCreditClienttDialog> createState() =>
      _EditCreditClienttDialogState();
}

class _EditCreditClienttDialogState
    extends ConsumerState<EditCreditClienttDialog>
